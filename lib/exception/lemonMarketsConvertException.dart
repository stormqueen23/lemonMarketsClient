...
class LemonMarketsConvertException extends LemonMarketsException {
  ...
  LemonMarketsConvertException(String url, String cause, int statusCode, String responseMap, StackTrace? stacktrace) : super(url, cause, statusCode, responseMap, stacktrace);
}